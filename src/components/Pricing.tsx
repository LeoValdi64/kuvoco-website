            ...
            >
              ...
              {tier.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-white bg-[#3B82F6] rounded-full">
                    <Sparkles size={12} />
                    Most Popular
                  </span>
                </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {maintenance.map((plan) => (
              <div
                key={plan.name}
                className="p-4 rounded-lg bg-[#1A1A2E]/30 border border-white/5 hover:border-white/10 transition-colors text-center"
              >
